...
namespace MyFinanceTracker.CommandProcessing.Text.Regex.Dispatching.Commands.AddTransaction;

using static MyFinanceTracker.CommandProcessing.Text.Regex.Logging.LogEvents.AddCommandHandler;
