...
namespace MyFinanceTracker.InputProcessing.Text.Gemini.Logging;
...
internal static class LogEvents
{
    ...
    public static class Processor
    {
        ...
        public const int EmptyResponse = SubBase + 4;
        public const int Exit = SubBase + 5;
        public const int Error = SubBase + 6;
    }
